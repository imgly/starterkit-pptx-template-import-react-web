...
For complete integration guides and API reference, visit the [PowerPoint Template Import Documentation](https://img.ly/docs/cesdk/js/starterkits/pptx-template-import-pptx01/).
...
curl -O https://staticimgly.com/imgly/cesdk-web-examples-data/1.80.0-rc.1/starterkit-pptx-template-import/demo-assets.zip
